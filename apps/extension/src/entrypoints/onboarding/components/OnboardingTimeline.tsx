                ...
                return (
                    <li
                        ...
                        className={`flex ${isLast ? 'items-center' : 'w-full items-center'} ${isCompleted ? 'text-teal-600' :
                                ...
                                ` after:content-[''] after:w-full after:h-1 after:border-b ${isCompleted ? 'after:border-teal-600' :
                                    isActive ? 'after:border-[var(--color-primary)]' :
                                        'after:border-[var(--color-muted)]'
