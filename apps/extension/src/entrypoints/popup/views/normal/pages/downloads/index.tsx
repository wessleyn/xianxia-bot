                ...
                {novels.length > 0 ? (
                    <div className="space-y-3">
                        {filteredNovels().map((novel) => (
                            <div key={novel.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                                <div className="p-3 flex gap-3">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            <h3 className="font-bold text-gray-800 dark:text-gray-100 leading-tight">{novel.title}</h3>
                                            ...
                                            <ul className="space-y-1.5">
                                                {[...Array(5)].map((_, i) => (
                                                    <li key={i} className="flex justify-between text-xs p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded">
                                                        <span className="text-indigo-700 dark:text-indigo-400 font-medium">Chapter {novel.id === 1 ? i + 530 - 4 : i + 214 - 4}: {novel.title} {novel.id === 1 ? i + 530 - 4 : i + 214 - 4}</span>
