        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="space-y-4">
                {bookmarks.map((bookmark) => (
                    <div key={bookmark.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="p-3">
                            <h3 className="font-medium text-gray-800">{bookmark.chapterTitle}</h3>
