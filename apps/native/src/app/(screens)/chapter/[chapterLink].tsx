    ...
    useEffect(() => {
        const fetchChapterContent = async () => {
            ...
            if (source) {
                ...
                throw ("Source not found or unsupported.");
            }
        }
        fetchChapterContent();
        ...
        <CustomView className="px-2">
            <View className="flex-row items-center justify-between border-b border-gray-200">
                ...
                <TouchableOpacity className="-mt-1 ">
                    <MaterialIcons name={isInLib ? 'library-add-check' : 'library-add'} size={24} color="#4b5563" />
                </TouchableOpacity>
            </View>
            <ScrollView
                ...
                >
                    <Text className="font-bold text-lg mb-4 mt-2">
                        {chapterContent.title}
                    </Text>
                    {
            ...
            <View className={`absolute bottom-0 left-0 p-3 px-5 w-full 
            bg-white bg-opacity-80 rounded-tl-lg
            flex-row items-center  justify-between shadow-md`}>
                <Text className="text-gray-700 mr-2 text-sm">
                    {currentTime}
                </Text>
                <View className="flex-row items-center">
                    ...
                    />
                    <Text className={`ml-1 text-sm ${batteryLevel > 0.2 ? "text-green-600" : "text-red-500"}`}>
            ...
            >
                <View className="mt-4 flex">
                    ...
                    <View className="flex-row items-center justify-between mt-4">
                        ...
                        {/* use this to slide across the current chapter */}
                        <Slider
                ...
                <View className="flex-row  gap-1">
                    ...
                    <View className="flex-row  p-2 gap-3 items-center bg-gray-300 rounded-xl w-[54%]">
                        <NovelImage
