...
const Footer = () => {
    return (
        <div className="container slide-enter">
                    ...
                    <div className="text-right">
                        ...
                        <ul className="footer__socials flex justify-end space-x-4">
                            <li className="footer__social-item">
                                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                            ...
                            <li className="footer__social-item">
                                <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="text-gray-600 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400">
                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-current">
